  ...
  return (
    <div className="py-20" id="projects">
      <h1 className="heading">
        A small slection of <span className="text-purple">recent projects</span>
      </h1>
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-10 mt-10">
        {projects.map(({ id, title, des, img, iconLists, link, live }) => (
          <div
            key={id}
            className="lg:min-h-[32.5rem] h-[25rem] flex items-center justify-center sm:w-[500px] w-[80vw]"
          >
